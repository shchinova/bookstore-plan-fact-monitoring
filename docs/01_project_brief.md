...
**В демо** для демонстрации ежедневный запуск по расписанию не настраивался. Скрипт был запущен вручную два раза: после первичной загрузки данных и после обновления данных на 15.04.2026.
